window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function HeroAgentPresetSeat({ sessions }) {
			...
			const label = snapshot.dshPresets.find((preset) => preset.id === snapshot.preset)?.name ?? snapshot.preset;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: snapshot.dshPresets.map((preset) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						type: "button",
						role: "menuitem",
